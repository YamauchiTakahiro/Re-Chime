...
namespace nsK2Engine {
    void ShadowMapRender::Init(bool isSoftShadow)
    {
        ...
        // 1e30f でクリア = 「オクルーダーなし（far端より遠い）」を表す。
        // exp(40*depth) の最大値 exp(40)≈2.35e17 より十分大きい値なので
        // テストピクセルの pos が cleared値を超えることなく、正しく「影なし」と判定される。
        float clearColor[4] = { 1e30f, 1e30f, 1.0f, 1.0f };
