...
{
public:
    enum enRareRobotState
    {
        enRareRobotState_Idle,		//待機状態。
        enRareRobotState_Walk,		//移動状態。
        enRareRobotState_Attack,	//攻撃状態。
        enRareRobotState_Death,		//死亡状態。
        enRareRobotState_Num,
    };
    RareRobot();
    ~RareRobot();
    bool Start() override;
